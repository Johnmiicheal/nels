...
export default function Blog() {
  ...
  return (
    <PageProvider title="My Blog">
        <Hero />
      <Layout>
        <Flex direction={{ base: 'column', lg: 'row'}} gap={10} py={5} w="full" justify={"space-between"}>
            <Stack>
                {currentPageData.map(({ _id, publishedAt, title, slug, summary }: any) => (
            ...
            <Box p={3} h="fit-content" w={{ base: "full", lg: '500px'}} border="1px solid #e2e2e2" rounded="md">
                <Text fontSize={18} fontWeight={600} mb={7}>Categories</Text>
